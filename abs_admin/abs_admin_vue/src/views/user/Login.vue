  ...
  methods: {
        ...
        if (!err) {
          ...
          getSmsCaptcha({ mobile: values.mobile }).then(res => {
            ...
            this.$notification['success']({
              message: 'hint',
              description: 'The verification code was obtained successfully. Your verification code is:' + res.result.captcha,
              duration: 8
            })
          }).catch(err => {
            setTimeout(hide, 1)
    ...
    requestFailed (err) {
      ...
      this.$notification['error']({
        message: 'mistake',
        description: ((err.response || {}).data || {}).msg || 'There was an error in the request, please try again later',
        duration: 4
      })
    }
  }
